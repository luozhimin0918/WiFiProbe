...
/**
 * Created by chenzhy on 2018/4/19.
 */

public class MyTextWatcher implements TextWatcher {
    private int beforeDot;
    private int afterDot;
    private OnAfterTextChangeListener mListener;
    /**
     * 构造器
     *
     ...
     */
    public MyTextWatcher(int beforeDot, int afterDot,OnAfterTextChangeListener listener) {
    ...
    interface OnAfterTextChangeListener{
