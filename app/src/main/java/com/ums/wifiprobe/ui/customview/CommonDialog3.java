...
public class CommonDialog3 extends Dialog implements View.OnClickListener{
    ...
    public CommonDialog3(Context context, int themeResId, String content) {
        super(context, themeResId);
        this.mContext = context;
        this.content = content;
    }

    public CommonDialog3(Context context, int themeResId, String content, OnDialogCloseListener listener) {
        super(context, themeResId);
        this.mContext = context;
        this.content = content;
    ...
    public CommonDialog3 setContent(String content){
        this.content = content;
        return this;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_common_trance);
